---
title: "Preprocessing of Cph overexpression samples"
...
raw_sce <- lapply(setNames(seq_along(file_names),sample_ids), function(index){
  ...
  tmp <- read10xCounts(samples = here("raw_data", "CphUp", file, "raw_feature_bc_matrix"),
                      sample.names = sample)
...
saveRDS(sce_qc, here("output", "CphUp_qced.rds"))
```
