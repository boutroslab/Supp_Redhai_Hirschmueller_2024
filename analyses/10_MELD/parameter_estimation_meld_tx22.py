...
pca_data = pd.read_csv("./output/MELD/pca_data_tx22.tsv", sep="\t",
                       index_col="cell_barcode")
mdata = pd.read_csv(".output/MELD/mdata_tx22.tsv", sep="\t",
                    index_col="cell_barcode", low_memory=False)
                    
data = pd.read_csv("./output/MELD/norm_cnts_tx22.tsv", sep="\t",
                   index_col="cell_barcode")
...
results.to_csv("./output/MELD/parameter_search_meld_tx22.csv", sep="\t",index=False)
