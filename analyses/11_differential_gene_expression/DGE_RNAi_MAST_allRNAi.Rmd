...
saveRDS(MAST_results, here("output", "differential_expression", "MAST", "MAST_res_coarse_all.rds"))
...
```{r}
MAST_results <- readRDS(here("output", "differential_expression", "MAST", "MAST_res_coarse_all.rds"))
        ...
        MAST_results[[celltype]][[condition]] %>%
            ...
            data.table::fwrite(.,
                file = here(
                    ...
                    str_interp("MAST_diff_expr_${condition}_${celltype}_coarse_all.tsv")
                ),
                sep = "\t",
                scipen = 50,
                row.names = F
