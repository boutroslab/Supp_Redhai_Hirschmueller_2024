...
pdf('../results/figures/DiffBind_MAplot_deseq.pdf')
dba.plotMA(dbObj, method=DBA_DESEQ2)
dev.off()

# concentrations of each sample groups plotted against each other.
pdf('../results/figures/DiffBind_MAplot_bXY.pdf')
...
pdf('../results/figures/DiffBind_boxplot.pdf')
...
write.table(out, file="../results/tables/diffbind_results.tsv", sep="\t", quote=F, row.names=F)