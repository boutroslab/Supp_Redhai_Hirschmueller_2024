...
## Introduction
Plot sff expression in  ISCs and EEP and split by perturbation status
...
p <- FetchData(progenitors, c("sff", "high_res_annotation", "perturbation")) %>%
    ...
    geom_point(size = 0.65, stroke = 0.4, shape = 21, mapping=aes(color = perturbation, fill = perturbation),
