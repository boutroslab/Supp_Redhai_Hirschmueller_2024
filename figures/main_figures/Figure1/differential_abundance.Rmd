...
final_plot <- wrap_plots(
    major_celltypes_plots$ISC, ee_subtypes_plots$EEP, major_celltypes_plots$EE, ee_subtypes_plots$`Tk-EE`, ee_subtypes_plots$`AstC-EE`, major_celltypes_plots$EB, nrow = 1
) & theme(
...
ggsave(filename = here::here("plots", "main", "Fig1_abundance_change.pdf"),
       plot = final_plot,
       width=8, 
       height=1.8,
       scale=1.5)
