...
ctrl_umap <- new_dimplot(EE_ctrl_integrated, feature = "high_res_annotation",size=0.6,
               shape=19,
               stroke=0.25)+
...
notch_umap <- new_dimplot(EE_notch_integrated, feature = "high_res_annotation",size=0.6,
               shape=19,
               stroke=0.25)+
    small_axis("UMAP ", fontsize = 5, arrow_length = 17) +
...
ggsave(plot = umaps_ee,
   width = 6, 
   height = 3,
   filename= here("plots", "main", "Fig2_EE_UMAPs.pdf"),
   scale=1.5)
...
ctrl_cph_expression <- new_dimplot(EE_ctrl_integrated, feature = "CG9650",size=0.6,
               shape=19,
               stroke=0.25)+
    small_axis("UMAP ", fontsize = 5, arrow_length = 17) +
    ggtitle("Control") +
...
notch_cph_expression <- new_dimplot(EE_notch_integrated, feature = "CG9650",size=0.6,
               shape=19,
               stroke=0.25)+
    small_axis("UMAP ", fontsize = 5, arrow_length = 17) +
    ggtitle("Notch-deficient") +
...
ggsave(plot = umaps_ee,
   width = 6, 
   height = 3,
   filename= here("plots", "main", "Fig2_EE_Cph_expr.pdf"),
   scale=1.5)
