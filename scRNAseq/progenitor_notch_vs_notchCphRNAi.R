...
# here we are only interested in progenitor cells
sce <- sce[, sce$tmp_celltype == "Progenitor"]
...
saveRDS(MAST_results, here("output", "differential_expression", "MAST", "MAST_Progenitor_NotchRNAi_vs_NotchCphRNAi.rds"))
