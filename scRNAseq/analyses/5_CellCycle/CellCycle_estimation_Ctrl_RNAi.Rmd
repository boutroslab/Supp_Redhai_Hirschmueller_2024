...
```{r}
ctrl <- readRDS(here("output", "ctrlRNAi_seurat_integrated_annotated_high_res.rds"))
...
saveRDS(ctrl, here("output", "ctrlRNAi_seurat_integrated_annotated_high_res_cellcycle.rds"))
```
