---
title: "Preprocessing of Notch KO"
...
sample_ids <- c("TX22_N", "TX23_N") # this is our internal ID
...
raw_sce <- lapply(setNames(seq_along(file_names), sample_ids), function(index) {
    ...
    tmp <- read10xCounts(
        samples = here("raw_data", "NotchKO", file, "raw_feature_bc_matrix"),
        sample.names = sample
    )
...
saveRDS(sce_qc, here("output", "notchKO_qced.rds"))
```
