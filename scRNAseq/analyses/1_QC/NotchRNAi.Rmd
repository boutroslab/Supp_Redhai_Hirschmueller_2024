---
title: "Preprocessing of Notch RNAi samples"
...
raw_sce <- lapply(setNames(seq_along(file_names), sample_ids), function(index) {
    ...
    tmp <- read10xCounts(
        samples = here("raw_data", "NotchRNAi", file, "raw_feature_bc_matrix"),
        sample.names = sample
    )
...
In this case, TX49 had crazy amounts of mitochondrial reads.. median and mean of ~40%
...
# for tx49 we will manually do cells with more than 10%
...
mitochondrial_filter_mask$TX49 <- raw_sce$TX49$subsets_Mito_percent > 10
...
saveRDS(sce_qc, here("output", "notchRNAi_qced.rds"))
```
