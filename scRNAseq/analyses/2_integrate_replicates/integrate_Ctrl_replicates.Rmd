---
title: "Integration of the Ctrl replicates"
...
ctrl <- readRDS(here("output", "ctrlKO_qced.rds"))
...
ctrl_split <- lapply(setNames(seq_along(file_names), sample_ids), function(index) {
    ...
    sce_tmp <- ctrl[[sample]]
    tmp <- Read10X(data.dir = here("raw_data", "CtrlKO", file, "raw_feature_bc_matrix"))
...
saveRDS(ctrl_integrated, here("output", "ctrlKO_seurat_integrated.rds"))
```
