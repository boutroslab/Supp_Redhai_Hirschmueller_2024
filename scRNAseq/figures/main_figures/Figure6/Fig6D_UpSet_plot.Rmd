...
listInput <- list(
    up_notchRNAi = upregulated_notchRNAi,
    down_notchRNAi = downregulated_notchRNAi,
    up_notchCphRNAi = upregulated_notchCphRNAi,
    down_notchCphRNAi = downregulated_notchCphRNAi
)
...
pdf(here::here("scRNAseq", "plots", "main", "Fig6D_upset_plot.pdf"),
