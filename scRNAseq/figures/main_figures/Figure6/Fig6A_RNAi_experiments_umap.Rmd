---
title: "Figure 6 RNAi experiments"
...
```{r}
seurat <- readRDS(here::here("output", "RNAi_experiments_integrated.rds"))
seurat <- seurat[, seurat$perturbation %in% c("ctrl", "NotchCphRNAi", "NotchRNAi")]
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq","plots", "main", "Fig6A_RNAi_experiments_celltype.pdf"),
    width = 5,
    height = 5
)
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq","plots", "main", "Fig6A_RNAi_experiments_condition.pdf"),
    width = 5.5,
    height = 5
)
```
