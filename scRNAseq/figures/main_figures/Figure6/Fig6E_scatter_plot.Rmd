...
interesting_genes <- c(
    ...
    "Myc", "spdo", "sli", "crol", "endos", "arm", "msi", "Non1", "mnb", 
    "sima", "Mad", "path", "Egfr", "mira", "EcR", "N", "mip40", "CycA", 
    "InR", "Dp", "esg", "kuz", "kibra", "Cdc7", "grp", "Pdi", "Cph", "sc"
)
```
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq", "plots", "main", "Fig6E_correlation_plot.pdf"),
    width = 3.9,
    height = 3,
    scale=2.5
)
