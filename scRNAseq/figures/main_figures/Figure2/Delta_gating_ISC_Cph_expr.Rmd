...
# Check if the expression is different between high and low of the same condition
```{r}
...
```{r}
res <- parallel::mclapply(unique(seurat_isc$Delta_status), function(delta_status) {
