---
title: "Figure 7 Sff and Cph coexpression"
...
```{r}
plots <- plot_density(integrated, c("CG9650", "sff"),
    joint = T, reduction = "umap",
    size = 0.01, shape = 19, combine = F
)
...
ggsave(
    filename = here("scRNAseq","plots", "main", "Fig7B_sff_cph_coexpression_umap_density.pdf"),
    width = 4, height = 3.5,
    plot = p,
    scale=1.5
)
