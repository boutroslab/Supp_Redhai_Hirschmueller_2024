...
final_plot <- (wrap_plots(
    major_celltypes_plots$ISC, major_celltypes_plots$EEP, major_celltypes_plots$EE, ee_subtypes_plots$`Tk-EE`, ee_subtypes_plots$`AstC-EE`, major_celltypes_plots$EB,
    nrow = 1
) & theme(
...
ggsave(
    filename = here::here("scRNAseq","plots", "main", "Fig1C_abundance_change.pdf"),
    plot = final_plot,
    width = 8,
    height = 2.4,
    scale = 1.5
