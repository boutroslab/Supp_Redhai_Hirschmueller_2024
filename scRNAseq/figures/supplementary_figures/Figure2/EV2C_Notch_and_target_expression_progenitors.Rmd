---
title: "Supp Figure 2 Notch and notch target gene expression"
...
### FOR P VALUES: see script: analyses/11_differential_gene_expression/DGE_profiling_MELD.Rmd
diff_res <- data.table::fread(
    here("output", "differential_expression", "pseudobulk_coarse_meld", "Progenitor",   "edgeR_diff_expr.tsv")
    )
...
ggsave(
    plot = p,
    filename = here("scRNAseq","plots", "sup", "ExtFig2C_N_expression.pdf"),
    width = 1.75,
    height = 1.3,
    scale = 2
)
...
ggsave(
    plot = p,
    filename = here("scRNAseq","plots", "sup", "ExtFig2C_marker_gene_expression.pdf"),
    width = 5.1,
    height = 2,
    scale = 1.5
)
