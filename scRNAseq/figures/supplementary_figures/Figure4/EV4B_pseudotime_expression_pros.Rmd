---
title: "Sup Fig 4 pseudotime expression"
...
ggsave(
    plot = p,
    file = here("scRNAseq", "plots", "sup", "EV4B_pseudotime_expression_ctrl.pdf"),
    width = 6,
    height = 5,
    units = "in",
    scale = 1.4
...
ggsave(
    plot = p,
    file = here("scRNAseq", "plots", "sup", "EV4B_pseudotime_expression_notch.pdf"),
    width = 6,
    height = 5,
    units = "in",
    scale = 1.4
