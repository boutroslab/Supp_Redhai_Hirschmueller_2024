---
title: "Figure 4 Show Cph Expression in EEPs as Violine plot"
...
mast_res %>% rownames_to_column("gene") %>% filter(gene=="CG9650")
...
ggsave(
    filename = here("scRNAseq","plots", "sup", "EV4E_Cph_expression.pdf"),
    plot = p,
