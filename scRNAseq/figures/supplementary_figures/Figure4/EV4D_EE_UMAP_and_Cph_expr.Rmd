---
title: "EV 4 EE UMAP and Cph Expression"
...
combined <- readRDS(here("output", "Ctrl_NotchKO_integrated_scent.rds"))
DefaultAssay(combined) <- "RNA"
ctrl <- combined[,combined$perturbation == "ctrl"]
...
```{r}
# load the annotated seurat object
notch <- combined[,combined$perturbation == "notch"]
...
ggsave(
    ...
    width = 6,
    height = 3,
    filename = here("scRNAseq", "plots", "sup", "EV4D_EE_UMAPs.pdf"),
    scale = 1.5
)

max_expression <- rbind(
    FetchData(EE_ctrl_integrated, "CG9650"),
    FetchData(EE_notch_integrated, "CG9650")
)[, 1] %>% max()
...
ggsave(
    ...
    width = 6,
    height = 3,
    filename = here("scRNAseq", "plots", "sup", "EV4D_EE_Cph_expr.pdf"),
    scale = 1.5
)
```
