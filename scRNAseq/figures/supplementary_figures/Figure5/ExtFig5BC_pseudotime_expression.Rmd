---
title: "Sup Fig 5 pseudotime expression"
...
ggsave(
    plot = p,
    file = here("scRNAseq","plots", "sup", "Fig5B_pseudotime_expression_ctrl.pdf"),
    width = 6,
    height = 5,
    units = "in",
    scale = 1.4
...
ggsave(
    plot = p,
    file = here("scRNAseq","plots", "sup", "Fig5B_pseudotime_expression_notch.pdf"),
    width = 6,
    height = 5,
    units = "in",
    scale = 1.4
