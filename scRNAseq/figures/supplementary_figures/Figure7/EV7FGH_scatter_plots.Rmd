---
title: "Supp Fig 7 scatter plot"
author: "Erica Valentini, modified by Nick Hirschmüller"
date: "2024-09-05"
output:
  html_document:
    df_print: paged
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq", "plots", "sup", "EV7F_correlation_plot_ISC.pdf"),
    width = 3.9,
    height = 3.1,
    scale=2.5
)
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq", "plots", "sup", "EV7G_correlation_plot_EB.pdf"),
    width = 3.9,
    height = 3.1,
    scale = 2.5
)
...
ggsave(
    plot = p,
    filename = here::here("scRNAseq", "plots", "sup", "EV7H_correlation_plot_ISC_EB.pdf"),
    width = 3.9,
    height = 3.1,
    scale=2.5
)
