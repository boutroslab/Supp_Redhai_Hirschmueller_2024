...
DefaultAssay(seurat_iscs) <- "RNA"
Idents(seurat_iscs) <- seurat_iscs$sc_expression  # "low" vs "high"

genes_of_interest <- c("CycE", "CycA", "E(spl)malpha-BFM", "klu")
...
res %>% filter(gene %in% genes_of_interest)
...
ggsave(
    ...
    width = 3.5,
    height = 3.5,
    filename = here("scRNAseq","plots", "sup", "EV6B_sc_gating_expression.pdf"),
    scale = 2
)
```
