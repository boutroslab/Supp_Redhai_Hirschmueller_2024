---
title: "Supp Figure 3 gene expression violine"
...
ggsave(
    plot = p,
    filename = here("scRNAseq","plots", "sup", "ExtFig3C_gene_expression.pdf"),
    width = 2.7,
    height = 3,
    scale = 2
)
