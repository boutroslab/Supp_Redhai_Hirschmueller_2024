...
ggsave(plot,
    filename = here("scRNAseq","plots", "sup", "ExtFig1A_Batch_UMAPs.pdf"),
    width = 8, height = 4.5
)
```
...
midgut_atlas <- data.table::fread(here("raw_data", "GSE120537_metadata.csv.gz")) %>% tibble()
...
ggsave(
    plot = p,
    filename = here("scRNAseq","plots", "sup", "ExtFig1D_cellnumbers.pdf"),
